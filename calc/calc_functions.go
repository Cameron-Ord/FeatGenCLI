...
func Unload_Json() []map[string]string {
	...
	jsonFile, err := os.ReadFile("json/FeatsData.json")
	if err != nil {
...
func Get_Requirements(Feat map[string]string, data InputData, stats_req *[]Stats_Tracker, skills_req *[]Skills_Tracker) {
...
func Run_Calculation(Feats []map[string]string, data InputData, allAllocatedFeats *[]string) error {
